...
TARGET_NAME="${FW_TARGET_NAME}-attack-coeff${TARGET_COEFF}"
...
make TARGET="$TARGET_NAME" \
     ...
     EXTRA_CFLAGS="-DATTACK_DECODER_SKIP_QHALF=1 -DATTACK_TARGET_COEFF=${TARGET_COEFF}" \
     "$OUT_HEX"

echo
echo "[ok] attack build outputs:"
